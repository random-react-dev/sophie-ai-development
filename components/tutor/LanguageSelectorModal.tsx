...
const POPULAR_CODES = ['es', 'fr', 'de', 'ja', 'zh', 'ko', 'it', 'pt', 'hi', 'ar'];
...
export default function LanguageSelectorModal({
    ...
    const filteredLanguages = useMemo(() => {
        ...
        if (!searchQuery.trim()) {
            const popular = languages.filter(lang => POPULAR_CODES.includes(lang.code));
            const others = languages.filter(lang => !POPULAR_CODES.includes(lang.code));
