...
export const SCENARIOS: Scenario[] = [
  {
    ...
    level: "S1",
    context:
      'You are at a café called "The Morning Grind". You want to order a coffee and something to eat.',
    icon: "coffee",
  },
  {
    id: "job-interview",
  ...
  },
  {
    ...
    level: "S2",
    context:
      "You are near Shibuya Crossing and need to get to the JR station but your phone battery is dead.",
    icon: "compass",
  },
  {
    id: "hotel-check-in",
    ...
    level: "S2",
    context:
      "You have a reservation under your name. You want to confirm the breakfast times and ask if there is a room with a nice view available.",
    icon: "bed",
  },
  {
    id: "political-debate",
    ...
    level: "S5",
    context:
      "Engage in a deep discussion about the balance between economic growth and environmental protection.",
    icon: "mic",
  },
];
