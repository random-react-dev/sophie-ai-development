...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    title: "Introduction",
    category: "Beginner",
    description: "Two people introduce themselves to each other.",
    sophieRole:
      "A friendly person sitting next to you at a language exchange meetup",
    userRole: "A newcomer at the meetup",
    topic: "Introduction",
    level: "S1",
    context:
  ...
  },
  {
    ...
    sophieRole: "A friend meeting at the park",
    userRole: "A friend sharing how they feel today",
    topic: "Basic emotions",
    level: "S1",
    context:
      "Two friends meet at the park and talk about how they feel today, sharing simple emotions like happy, sad, or tired. Keep the vocabulary simple and focus on basic expressions of feeling.",
    icon: "smile",
  },
];
