...
export const SUPPORTED_LANGUAGES: Language[] = [
    ...
    { code: 'fil', name: 'Filipino', nativeName: 'Filipino', flag: '🇵🇭', countryCode: 'ph' },
    { code: 'bn', name: 'Bengali', nativeName: 'বাংলা', flag: '🇧🇩', countryCode: 'bd' },
    { code: 'ta', name: 'Tamil', nativeName: 'தமிழ்', flag: '🇮🇳', countryCode: 'in' },
    { code: 'te', name: 'Telugu', nativeName: 'తెలుగు', flag: '🇮🇳', countryCode: 'in' },
    { code: 'mr', name: 'Marathi', nativeName: 'मराठी', flag: '🇮🇳', countryCode: 'in' },
    { code: 'gu', name: 'Gujarati', nativeName: 'ગુજરાતી', flag: '🇮🇳', countryCode: 'in' },
    { code: 'kn', name: 'Kannada', nativeName: 'ಕನ್ನಡ', flag: '🇮🇳', countryCode: 'in' },
    { code: 'ml', name: 'Malayalam', nativeName: 'മലയാളം', flag: '🇮🇳', countryCode: 'in' },
    ...
    { code: 'sk', name: 'Slovak', nativeName: 'Slovenčina', flag: '🇸🇰', countryCode: 'sk' },
    { code: 'bg', name: 'Bulgarian', nativeName: 'Български', flag: '🇧🇬', countryCode: 'bg' },
    { code: 'hr', name: 'Croatian', nativeName: 'Hrvatski', flag: '🇭🇷', countryCode: 'hr' },
    { code: 'sr', name: 'Serbian', nativeName: 'Српски', flag: '🇷🇸', countryCode: 'rs' },
    { code: 'sl', name: 'Slovenian', nativeName: 'Slovenščina', flag: '🇸🇮', countryCode: 'si' },
    { code: 'lt', name: 'Lithuanian', nativeName: 'Lietuvių', flag: '🇱🇹', countryCode: 'lt' },
    { code: 'lv', name: 'Latvian', nativeName: 'Latviešu', flag: '🇱🇻', countryCode: 'lv' },
    { code: 'et', name: 'Estonian', nativeName: 'Eesti', flag: '🇪🇪', countryCode: 'ee' },
    { code: 'fa', name: 'Persian', nativeName: 'فارسی', flag: '🇮🇷', countryCode: 'ir' },
    { code: 'ur', name: 'Urdu', nativeName: 'اردو', flag: '🇵🇰', countryCode: 'pk' },
    { code: 'sw', name: 'Swahili', nativeName: 'Kiswahili', flag: '🇰🇪', countryCode: 'ke' },
    { code: 'af', name: 'Afrikaans', nativeName: 'Afrikaans', flag: '🇿🇦', countryCode: 'za' },
];
